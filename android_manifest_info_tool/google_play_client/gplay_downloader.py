import os
from android_manifest_info_tool.google_play_client.Util import Util
...
class Operator:
    OPERATORS = {
        ...
        "Cambodia": {'Star-Cell': '45605', 'qb': '45604', 'Beeline': '45609', 'Smart Mobile': '45606',
                     'Mobitel': '45601', 'Metfone': '45608', 'hello': '45602', 'Mfone': '45618'},
        ...
        "El Salvador": {'Claro': '70611', 'Tigo': '70603', 'Digicel': '70602', 'CTE Telecom': '70601',
                        'Movistar': '70604'},
        ...
        "Chile": {'Claro': '73003', 'Nextel': '73009', 'Entel': '73001', 'Will': '73099', 'Movistar': '73002',
                  'VTR Movil': '73005'},
        "Belgium": {'Mobistar': '20610', 'Base': '20620', 'Proximus': '20601', 'Telenet': '20605'},
        "Germany": {'MobilCom': '26213', 'E-Plus': '26203', 'T-Mobile': '26201', 'Quam': '26214', 'O2': '26207',
                    'Vodafone': '26202'},
        "Haiti": {'Digicel': '37202', 'Voila': '37201'},
        "Belize": {'Digicell': '70267', 'Smart': '70299'},
        "Hong Kong": {'New World PCS': '45410', 'HK Telecom': '45400', 'Smartone Mobile': '45406',
                      'Peoples Telephone': '45412', 'P Plus': '45422', 'Pacific Link': '45418', 'Hutchison': '45404',
                      'Mandarin Com.': '45416'},
        "Taiwan": {'TransAsia': '46699', 'TINGSM': '46697', 'KG Telecom': '46688', 'TUNTEX': '46606',
                   'Chunghwa': '46692', 'Far Eastone': '46601', 'Mobitel': '46693'},
        "Spain": {'Xfera': '21404', 'Telefonica': '21407', 'Amena': '21403', 'Vodafone': '21401', 'Movistar': '21402'},
        "Georgia": {'Geocell': '28201', 'SILKNET': '28205', 'Iberiatel': '28203', 'Beeline': '28204',
                    'MagtiCom': '28202'},
        "Pakistan": {'Zong': '41004', 'Ufone': '41003', 'Telenor': '41006', 'Warid': '41007', 'Mobilink': '41001',
                     'Vodafone': '41008'},
        "Denmark": {'Orange': '23830', 'Debitel': '23800001', 'Telia Denmark': '23820', 'Denmark Mobil': '23801',
                    'Sonofon': '23802'},
        "Philippines": {'Sun': '51505', 'Globe': '51502', 'Islacom': '51501', 'Smart': '51503'},
        "Vietnam": {'3G EVNTelecom': '45208', 'S-Fone': '45203', 'Vietnam Mobile': '45205', 'EVNTelecom': '45206',
                    'Vinaphone': '45202', 'Beeline VN': '45207', 'MobiFone': '45201', 'Viettel Mobile': '45204'},
        ...
        "Estonia": {'EMT': '24801', 'Estonian Mobile': '24801', 'Tele 2': '24803', 'Elisa': '24802',
                    'RadioLinja': '24802'},
        ...
        "India": {'Escotel Mobile': '40412', 'TATA Cellular': '40407', 'Ina Spice': '40014', 'Hutch': '40405',
                  'Dolphin': '40468', 'Videocon': '40584', 'Idea': '40422', 'Usha Martin Tel.': '40426',
                  'Orange': '40020', 'Oasis': '40470', 'Bharti Telecom': '40402', 'Ushafon': '40408',
                  'Airtel Digilink': '40401', 'BSNL Mobile': '40455', 'INA AIRTel': '40440', 'Ushafone': '40432',
                  'BPL USWest': '40421', 'Spice': '40441'},
        ...
        "Burundi": {'Omatel': '64203', 'Smart Mobile': '64207', 'Spacetel': '64201', 'Africell': '64202',
                    'U-COM Burundi': '64282'},
        ...
        "Netherlands Antilles": {'Telcell': '36251', 'UTS': '36291', 'Digicel': '36269', 'MIO': '36295',
                                 'Bayos': '36294'},
        "Italy": {'BLU': '22298', '3': '22299', 'Wind Tel.': '22288', 'Telecom Italia': '22201', 'Vodafone': '22210'},
        "Bangladesh": {'TeleTalk': '47004', 'Gremenphone': '47001', 'CityCell': '47005', 'Banglalink': '47003',
                       'Warid Telecom': '47007', 'Airtel': '47006', 'Robi': '47002'},
        "USA": {'Wireless 2000': '31011', 'Powertel': '31027', 'BellSouth': '31015', 'Aerial': '31031',
                'Iowa Wireless': '31077', 'Western Wireless': '31026', 'Cingular': '31017', 'AT&T': '31038',
                'Sprint': '31002', 'T-Mobile': '31020'},
        ...
        "Netherlands": {'Telfort': '20412', 'Tele 2': '20402', 'T-Mobile': '20416', '6GMobile': '20414',
                        'Vodafone': '20404', 'Orange': '20420', 'KPN': '20408'},
        ...
        "Singapore": {'StarHub': '52205', 'GSM 900': '52501', 'GSM 1800': '52502', 'MobileOne Asia': '52503',
                      'M1-3GSM': '52504'},
        ...
        "Indonesia": {'Ceria': '51027', 'XL': '51011', 'StarOne': '51003', 'TELKOMMobile': '51020', 'PSN': '51000',
                      'SMART': '51009', 'AXIS': '51008', 'TelkomFlexi': '51007', 'Fren\\/Hepi': '51028', '3': '51089',
                      'Telkomsel': '51010', 'INDOSAT': '51001'},
        "Finland": {'Radjolinja': '24405', 'Finnet Group': '24409', '2G': '24412', 'Telia Finland': '24403',
                    'Sonera Corp.': '24409', 'AMT': '24414'},
        ...
        "Sweden": {'Orange': '24003', 'Vodafone': '24008', '3 Sweden': '24002', 'Telia Mobitel': '24001',
                   'Comviq': '24007'},
        ...
        "Russia": {'North Caucasian': '25044', 'Megafon': '25002', 'BeeLine': '25099', 'New Telephone Cy': '25012',
                   'Don Telecom': '25010', 'MTS Moscow': '25001', 'Uratel': '25039', 'Kuban GSM': '25213',
                   'Zao Smarts': '25007', 'Siberian Cellular': '25005'},
        ...
        "United Kingdom": {'3': '23420', 'Manx Pronto': '23450', 'Orange': '23433', 'Jersey Telecom': '23450',
                           'Guermsey Tel.': '23455', 'O2': '23410', 'Vodafone': '23415', 'T-Mobile': '23430'},
...
class AssetRequest:
    def __init__(self, package_name, auth_token, device_id, operator, device_name, sdk_version):
        self.encode_table = [0, [16], 2, [24], 4, [34], 6, [42], 8, [50], 10, [58], 12, [66], 14, [74], 16, [82], 18,
                             [90], 20, [19, 82], 22, [10], 24, [20]]
        self.pad = [10]
...
def gplay_download(email, password, package, device_id, country_code, operator_id, upload_folder=os.getcwd(),
                   sdklevel=21):
    try:
        ...
        if email is None:
        ...
        elif country_code is None or country_code not in Operator.OPERATORS:
            print("Empty or invalid country specified, choose from : \n\n" +
                  ", ".join(Operator.OPERATORS.keys()))

        elif operator_id is None or operator_id not in Operator.OPERATORS[country_code]:
            print ("Empty or invalid operator specified, choose from : "
                   "\n\n" + ", ".join(Operator.OPERATORS[country_code].keys()))
            ...
            print("@ Requesting package ..." + package)

            operator = Operator(str(country_code), str(operator_id))

            request = AssetRequest(package, market.token, str(device_id), operator, 'hammerhead', sdklevel)
            (url, market_da) = market.get_asset(request.encode())

            print(url)
            Util.download_apk(package, url, market_da, upload_folder)
...
if __name__ == '__main__':
    try:
        ...
        parser = optparse.OptionParser(usage="usage: %prog [options]\n\n" +
                                             "EXAMPLE:\n" +
                                             "\t%prog --configfile path-to-config-file --output path-to-output-folder (optional)"
                                       )

        parser.add_option("-c", "--configfile", action="store", dest="config_file", default=None,
                          help="Path to config file on the system.")
        parser.add_option("-p", "--output", action="store", dest="output", default=None,
                          help="Path to output text file.")

        (o, args) = parser.parse_args()

        if o.config_file is None:
            print "No config path is specified."

        else:
            if o.output is None:
                o.output = os.getcwd()

            email, password, device_id, operator, country_code, package = read_config_file(o.config_file)
            gplay_download(email, password, package, device_id, country_code, operator, o.output)
